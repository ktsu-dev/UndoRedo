...
- Merge remote-tracking branch 'origin/main' into rename/retire-core-package-id ([@Claude](https://github.com/Claude))
...
## v1.0.7-pre.5 (prerelease)

Changes since v1.0.7-pre.4:
